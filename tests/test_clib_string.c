...
test (test_clib_string_builder,
      "the string builder builds a string",
    ...
    test (test_clib_string_length,
        ...
        test (test_clib_string_copy,
            ...
            test (test_clib_string_cmp,
                  "clib_string_cmp compares two strings",
                  init_console ();
                  printf ("- Testing %s\n", __func__);
                  ...
                  cheat_assert (clib_string_cmp (str_a2, str_b2)
                                == strcmp (str_a2, str_b2));
                  const char *const str_a3 = "xxBABxx";
                  const char *const str_b3 = "xxABAxx";
                  printf("%d : %d\n", clib_string_cmp (str_a3, str_b3), strcmp (str_a3, str_b3));
                ...
                test (test_clib_string_replace_char,
                      ...
                      const int replaced
                      = clib_string_replace_char (str, 'l', 'x');
                      printf ("- Testing %s\n", __func__);
                      cheat_assert (
                          strcmp (str, "hexlo world") == 0 && replaced == 1);)

                    test (test_clib_string_replace_char_all,
                          "clib_string_replace_char_all replaces a occurences "
                          "of char",
                          init_console ();
                          char str[] = "hello world";
                          const size_t replaced
                          = clib_string_replace_char_all (str, 'l', 'x');
                          printf ("- Testing %s\n", __func__);
                          cheat_assert (strcmp (str, "hexxo worxd") == 0
                                        && replaced == 3);)

                        test (test_clib_string_dist_lev,
                              "clib_string_dist_lev gets the levenshtein "
                              "distance of to strings",
                              init_console ();
                            ...
                            test (test_clib_string_from_int,
                                  "clib_string_from_int stringifys the given "
                                  "number",
                                  init_console ();
                                  ...
                                  clib_string_from_int (
                                      res_a, a, CLIB_RADIX_DEC);
                                  clib_string_from_int (
                                      res_b, b, CLIB_RADIX_HEX);
                                ...
                                test (test_clib_string_reverse,
                                      ...
                                      printf ("- Testing %s\n", __func__);
                                      clib_string_reverse (
                                          a, res_a, clib_string_length (a));
                                      cheat_assert_string (res_a, expected_a);)

                                    test (test_clib_string_reverse_in_place,
                                          "clib_string_reverse_in_place "
                                          "reverses a string in place",
                                          init_console ();
                                          char a[] = "AACHEN";
                                          const char *const expected_a
                                          = "NEHCAA";
                                          printf ("- Testing %s\n", __func__);
                                          clib_string_reverse_in_place (
                                              a, clib_string_length (a));
