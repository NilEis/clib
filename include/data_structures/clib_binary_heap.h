/** @file
 * @brief provides types and functions for binary heaps
 */
#if !defined(CLIB_BINARY_HEAP_H) && defined(CLIB_INCLUDE_DATA_STRUCTURES)
#define CLIB_BINARY_HEAP_H
